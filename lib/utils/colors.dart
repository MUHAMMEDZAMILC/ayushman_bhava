...
class ColorResources {
  ...
  static const Color LOGINHEAD = Color(0xFF404040);
  static const Color TEXTFEILDFILL = Color(0xFFD9D9D9);
  static const Color BUTTONBGCOLOR = Color(0xff006837);
  static const Color HOMECONTACOLOR = Color(0xffF1F1F1);
  static const Color CONTAINERGREYCOLOR = Color(0xFFF0F0F0);
  static const Color TEXTGREEN = Color(0xff006837);
  static const Color BUTTONBGLIGHT = Color(0xff389A48);
  static const Color BUTTONTEXT = Color(0xff006837);
  static const Color SCAFFOLDBGOLD = Colors.white;
